        ...
        <div class="col-md-4 text-center">
            ...
            <div class="col-md-12">
                <div class="progress progress-book">
                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="{{$product->percent_complete}}"
                         aria-valuemin="0" aria-valuemax="100" style="width: {{$product->percent_complete}}%">
